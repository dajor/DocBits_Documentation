...
1. [Configura il tuo client MCP](setup-and-configuration-it.md)
2. Scopri gli [Strumenti per i Workflow](workflow-tools-it.md)
3. Esplora gli [Strumenti Card SDK](card-sdk-tools-it.md)
4. Segui gli [Esempi](examples-it.md) completi
